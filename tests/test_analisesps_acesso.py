...
TODAS_AS_TELAS = [
    ...
    ("GET", "/analisesps/api/fiscal/nota"),
    ("POST", "/analisesps/api/fiscal/reconferir"),
    ...
    ("GET", "/analisesps/fiscal?visao=dados_sps"),
    ("GET", "/analisesps/fiscal?visao=dados_notas"),
    ("GET", "/analisesps/credores"),
    ("POST", "/analisesps/credores/aplicar"),
    ("POST", "/analisesps/credores/consultar"),
    ("POST", "/analisesps/credores/sps"),
