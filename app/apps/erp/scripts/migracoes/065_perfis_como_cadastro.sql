...
-- Administrador
    ...
    ('Administrador','fin_empreitas','LER'),('Administrador','fin_avalizar','EDITAR'),
    ('Administrador','fin_aprovar','EDITAR'),('Administrador','fin_pagar','EDITAR'),
    ('Administrador','fin_conciliar','EDITAR'),('Administrador','fin_receber','EDITAR'),
    ('Administrador','fin_notas','EDITAR'),('Administrador','fin_relatorios','LER'),
    ('Administrador','obr_obras','LER'),('Administrador','obr_contratos','LER'),
    ...
    ('Administrador','sup_autorizar','EDITAR'),('Administrador','sup_locacoes','LER'),
    ('Administrador','sup_cadastros','EDITAR'),('Administrador','ger_arquivo','EDITAR'),
    ('Administrador','ger_encaminhar','EDITAR'),('Administrador','ger_equipe','LER'),
    ('Administrador','adm_configurar','EDITAR'),('Administrador','adm_operadores','EDITAR'),
    -- Diretor financeiro
    ('Diretor financeiro','fin_lancar','EDITAR'),('Diretor financeiro','fin_titulos','EDITAR'),
    ('Diretor financeiro','fin_empreitas','LER'),('Diretor financeiro','fin_avalizar','EDITAR'),
    ('Diretor financeiro','fin_aprovar','EDITAR'),('Diretor financeiro','fin_pagar','EDITAR'),
    ('Diretor financeiro','fin_conciliar','EDITAR'),('Diretor financeiro','fin_receber','EDITAR'),
    ('Diretor financeiro','fin_notas','EDITAR'),('Diretor financeiro','fin_relatorios','LER'),
    ('Diretor financeiro','obr_obras','LER'),('Diretor financeiro','obr_contratos','LER'),
    ...
    ('Diretor financeiro','sup_autorizar','EDITAR'),('Diretor financeiro','sup_locacoes','LER'),
    ('Diretor financeiro','sup_cadastros','EDITAR'),('Diretor financeiro','ger_arquivo','EDITAR'),
    ('Diretor financeiro','ger_encaminhar','EDITAR'),('Diretor financeiro','ger_equipe','LER'),
    -- Administrativo financeiro
    ('Administrativo financeiro','fin_lancar','EDITAR'),('Administrativo financeiro','fin_titulos','EDITAR'),
    ('Administrativo financeiro','fin_empreitas','LER'),('Administrativo financeiro','fin_aprovar','EDITAR'),
    ('Administrativo financeiro','fin_pagar','EDITAR'),('Administrativo financeiro','fin_conciliar','EDITAR'),
    ('Administrativo financeiro','fin_receber','EDITAR'),('Administrativo financeiro','fin_notas','EDITAR'),
    ('Administrativo financeiro','fin_relatorios','LER'),('Administrativo financeiro','obr_obras','LER'),
    ...
    ('Administrativo financeiro','sup_locacoes','LER'),('Administrativo financeiro','sup_cadastros','LER'),
    ('Administrativo financeiro','ger_arquivo','EDITAR'),('Administrativo financeiro','ger_encaminhar','EDITAR'),
    -- Gestor de obras
    ('Gestor de obras','fin_lancar','EDITAR'),('Gestor de obras','fin_titulos','LER'),
    ('Gestor de obras','fin_empreitas','LER'),('Gestor de obras','fin_avalizar','EDITAR'),
    ('Gestor de obras','fin_pagar','LER'),('Gestor de obras','fin_notas','LER'),
    ('Gestor de obras','fin_relatorios','LER'),('Gestor de obras','obr_obras','LER'),
    ('Gestor de obras','obr_contratos','LER'),('Gestor de obras','obr_notas_emitidas','LER'),
    ('Gestor de obras','obr_agenda','EDITAR'),('Gestor de obras','pes_despesas','EDITAR'),
    ('Gestor de obras','pes_colaboradores','LER'),('Gestor de obras','sup_solicitar','EDITAR'),
    ('Gestor de obras','sup_locacoes','LER'),('Gestor de obras','sup_cadastros','LER'),
    ('Gestor de obras','ger_arquivo','EDITAR'),('Gestor de obras','ger_encaminhar','EDITAR'),
    -- Supervisor de obras
    ('Supervisor de obras','fin_lancar','EDITAR'),('Supervisor de obras','fin_titulos','LER'),
    ('Supervisor de obras','fin_empreitas','LER'),('Supervisor de obras','fin_avalizar','EDITAR'),
    ('Supervisor de obras','fin_pagar','LER'),('Supervisor de obras','fin_notas','LER'),
    ('Supervisor de obras','fin_relatorios','LER'),('Supervisor de obras','obr_obras','LER'),
    ('Supervisor de obras','obr_agenda','EDITAR'),('Supervisor de obras','pes_despesas','EDITAR'),
    ('Supervisor de obras','pes_colaboradores','LER'),('Supervisor de obras','sup_solicitar','EDITAR'),
    ('Supervisor de obras','sup_locacoes','LER'),('Supervisor de obras','sup_cadastros','LER'),
    ('Supervisor de obras','ger_arquivo','LER'),('Supervisor de obras','ger_encaminhar','EDITAR'),
    -- Administrativo de obra
    ('Administrativo de obra','fin_lancar','EDITAR'),('Administrativo de obra','fin_titulos','LER'),
    ('Administrativo de obra','fin_empreitas','LER'),('Administrativo de obra','obr_obras','LER'),
    ('Administrativo de obra','obr_agenda','EDITAR'),('Administrativo de obra','pes_despesas','EDITAR'),
    ('Administrativo de obra','pes_colaboradores','LER'),('Administrativo de obra','sup_solicitar','EDITAR'),
    ('Administrativo de obra','sup_locacoes','LER'),('Administrativo de obra','sup_cadastros','LER'),
    ('Administrativo de obra','ger_arquivo','LER'),('Administrativo de obra','ger_encaminhar','EDITAR'),
    -- Departamento pessoal
    ('Departamento pessoal','fin_lancar','EDITAR'),('Departamento pessoal','fin_titulos','LER'),
    ('Departamento pessoal','fin_empreitas','LER'),('Departamento pessoal','obr_obras','LER'),
    ('Departamento pessoal','obr_agenda','EDITAR'),('Departamento pessoal','pes_despesas','EDITAR'),
    ('Departamento pessoal','pes_colaboradores','EDITAR'),('Departamento pessoal','sup_locacoes','LER'),
    ('Departamento pessoal','ger_arquivo','EDITAR'),('Departamento pessoal','ger_encaminhar','EDITAR'),
    -- Aprovador
    ('Aprovador','fin_lancar','LER'),('Aprovador','fin_titulos','LER'),
    ('Aprovador','fin_empreitas','LER'),('Aprovador','fin_aprovar','EDITAR'),
    ('Aprovador','fin_pagar','LER'),('Aprovador','obr_obras','LER'),
    ('Aprovador','obr_agenda','LER'),('Aprovador','sup_locacoes','LER'),
    ('Aprovador','ger_arquivo','LER'),('Aprovador','ger_encaminhar','EDITAR'),
    -- Lançador
    ('Lançador','fin_lancar','EDITAR'),('Lançador','fin_titulos','LER'),
    ('Lançador','fin_empreitas','LER'),('Lançador','obr_obras','LER'),
    ('Lançador','sup_locacoes','LER'),('Lançador','ger_encaminhar','EDITAR'),
    -- Consulta
    ('Consulta','fin_lancar','LER'),('Consulta','fin_titulos','LER'),
    ('Consulta','fin_empreitas','LER'),('Consulta','fin_notas','LER'),
    ('Consulta','obr_obras','LER'),('Consulta','obr_contratos','LER'),
    ('Consulta','obr_notas_emitidas','LER'),('Consulta','obr_agenda','LER'),
    ('Consulta','sup_solicitar','LER'),('Consulta','sup_locacoes','LER'),
    ('Consulta','sup_cadastros','LER'),('Consulta','ger_arquivo','LER'),
    -- Parceiro da obra
    ('Parceiro da obra','fin_lancar','LER'),('Parceiro da obra','fin_titulos','LER'),
    ('Parceiro da obra','fin_empreitas','LER'),('Parceiro da obra','fin_relatorios','LER'),
    ('Parceiro da obra','obr_obras','LER'),('Parceiro da obra','obr_agenda','LER'),
    ('Parceiro da obra','pes_despesas','LER'),('Parceiro da obra','pes_colaboradores','LER'),
    ('Parceiro da obra','sup_solicitar','LER'),('Parceiro da obra','sup_locacoes','LER'),
    ('Parceiro da obra','sup_cadastros','LER'),('Parceiro da obra','ger_arquivo','LER')
