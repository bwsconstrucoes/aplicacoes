...
MAPA_PADRAO: dict[str, str] = {
    ...
    "Locação de Equipamentos": "3.3.06",
    ...
    "Estorno de Pagamento": "3.5.02",
    "Pagamento Estornado": "3.5.02",

    # ---------------- receitas
    "Receita de Obras": "1.1.01",
    # Devolução e estorno saíram das receitas em 10/09/2026: viraram contas
    # REDUTORAS de custo, no grupo 3. O nome antigo do Omie continua aqui.
    "Receita de Devolução de Material": "3.5.01",
    "Estorno de Despesas": "3.5.02",
    "Reembolso de Custas processuais": "3.5.03",
...
MAPA_CODIGO_OMIE: dict[str, str] = {
    ...
    "2.02.01": "3.2.04", "2.02.02": "3.3.06", "2.02.03": "3.2.02",
