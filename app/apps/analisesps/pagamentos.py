# -*- coding: utf-8 -*-
"""
QR Pix e código de barras de boleto.

REAPROVEITADO do Streamlit sem mudar uma linha de regra: este arquivo só
depende de `re`, `io` e da biblioteca de código de barras. Não havia por que
reescrever — a montagem do BR Code, o dígito verificador e o desempate entre
CPF e celular custaram tempo para acertar e estão testados no uso diário.

A única mudança é o `import` do módulo vizinho, que dentro de um pacote precisa
ser relativo.
"""
"""
