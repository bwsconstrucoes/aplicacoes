...
COLUNAS = {
    ...
    "aporte_lancamentos": [("data", "Data"), ("obra", "Obra"),
                           ...
                           ("documento", "Documento"),
                           ("observacao", "Observação")],
    "aporte_dividendos": [("socio", "Sócio"), ("pago", "Distribuído a ele"),
                          ("recebido", "Entrou com nome de dividendo (conferir)"),
                          ("lancamentos", "Lançamentos")],
    "caixa_socios": [("obra", "Obra"), ("receitas", "Receitas recebidas"),
                     ("despesas", "Despesas pagas"),
                     ("resultado", "Resultado em caixa"),
